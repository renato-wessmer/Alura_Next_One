...
if (numberChosen == numberSecret) { /* If é a condicional que compara se numberChosen é igual ao numberSecret  */
    alert("Isso aí! você descobriu o número secreto (5)"); /* O console.log serve para verificarmos a execução do condicional no nosso projeto dentro do navegador web */
} else {
    alert('Você errou :(')
}
